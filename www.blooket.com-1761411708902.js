// ==UserScript== // @name BETTER BLOOKET HACKS // @namespace http://tampermonkey.net/ // @version 2025-03-05 // @description BEST GUI 2025 // @author poopersch4rtz // @match ://.blooket.com/* // @match ://blooket.com/ // @icon data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw== // @grant none // @downloadURL https://update.greasyfork.org/scripts/528823/BETTER%20BLOOKET%20HACKS.user.js // @updateURL https://update.greasyfork.org/scripts/528823/BETTER%20BLOOKET%20HACKS.meta.js // ==/UserScript==

/**

@license AGPL-3.0
Blooket Cheats
Made this to give to friends at School /* THE UPDATE CHECKER IS ADDED DURING COMMIT PREP, THERE MAY BE REDUNDANT CODE, DO NOT TOUCH */
(() => { let iframe = document.querySelector("iframe"); if (!iframe) { iframe = document.createElement("iframe"); iframe.style.display = "none"; document.body.append(iframe); } /* By pooperschw4rtz - TikTok */ if (window.fetch.call.toString() == 'function call() { [native code] }') { const call = window.fetch.call; window.fetch.call = function () { if (!arguments[1].includes("s.blooket.com/rc")) return call.apply(this, arguments); } } const timeProcessed = 1732772258234; let latestProcess = -1; const cheat = (async () => { const versionName = "v1"; const gui = document.createElement("div"); Object.assign(gui.style, { top: window.innerHeight / 2 - 250 + "px", left: innerWidth / 2 - 400 + "px", }); const variables = { "--highlight": "#f90000", "--highlight2": "#4F4789", "--background": "#000000", "--background2": "#202020", "--textColor": "#f90000", "--textColor2": "#f90000", "--toggleOff": "#E32424", "--toggleOn": "#24E324", };
    ...
    credit.innerText = "Created by Pooper";
    ...
    licenseMessage.innerHTML = `<i class="" style="line-height: 1;aspect-ratio: 1 / 1;height: 20px;display: inline-grid;place-items: center;"></i>  <a style="color: var(--highlight);" target="_blank" href=""></a> <a style="color: var(--highlight);" target="_blank" href=""></a><br>`;

    const copyrightTag = document.createElement("span");
    copyrightTag.className = classes.copyrightTag;

    copyrightTag.innerText = `Copyright © ${new Date().getFullYear()} pooperschw4rtz`;

    const codingCredits = document.createElement("ul");
    codingCredits.className = classes.codingCredits;

    codingCredits.append(createCredit("GUI Design + Creation", "pooperschw4rtz"));
    codingCredits.append(createCredit("", ""));
    codingCredits.append(createCredit("", ' <i class=""></i>  <i class=""></i> '));

    const creditLinks = document.createElement("ul");
    creditLinks.className = classes.creditLinks;

    creditLinks.append(createCredit("", '<a target="_blank" href=""></a>'));
    creditLinks.append(createCredit("", '<a target="_blank" href=""></a>'));
    creditLinks.append(createCredit("ADD ME ON DISCORD IF YOU NEED SOMETHING!!!", '<a target="_blank" href="http://discordapp.com/users/1245457915993657405">CLICK HERE!!!!</a>'));
    ...
    try {
        ...
        uploadDates.append(createCredit("Current GUI Upload Date", parseDate()));
        if (latestProcess != -1) uploadDates.append(createCredit("Latest GUI Upload Date", parseDate(latestDate)));
        if (currentDate < latestDate) {
            const warning = document.createElement("span");
            warning.className = classes.warning;
            warning.innerText = "You are using an outdated version of GUI.";
            uploadDates.append(warning);
        }
    } catch {
        const warning = document.createElement("span");
        warning.className = classes.warning;
        warning.innerText = "Made this script for the mfs that want ts at my school.";
        uploadDates.append(warning);
    }
...
VM109:3863 Uncaught SyntaxError: Unexpected end of input
// ==UserScript==
